...
class users(db.Model):
    ...
    user_address = db.Column(db.String(255), primary_key=False)
    user_city = db.Column(db.String(255), primary_key=False)
    user_state = db.Column(db.String(255), primary_key=False)
    zip_code = db.Column(db.String(255), primary_key=False)
